...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        self.create_new_contact(wd, name="Tatiana", midname="V", lastname="Kotova", nickname="TKotova",
    ...
    def test_test_add_empty_contact(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.open_contact_page(wd)
        self.create_new_contact(wd, name="", midname="", lastname="", nickname="",
                                title="", company="",
    ...
    def create_new_contact(self, wd, name, midname, lastname, nickname, title, company, address, home, mobile, work,
                           fax, email1, email2, email3, homepage, day, month, year, aday, amonth, ayear, address2,
                           phone2, notes):
